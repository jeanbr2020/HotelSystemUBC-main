...
public class HotelSystem {
    ...
    public System(HotelController hotelController, HotelView hotelView, Scanner scanner) {
    ...
    private void listarHospedes() {
        ...
        List<Hotel> Hotel = hotelController.listarHospedes();
        hotelView.mostrarListaHospede(Hotel);
        System.out.println("===========================");
    }
    ...
    private void atualizarHospedes() {
        ...
        Hotel livro = hotelController.buscarLivro(id);
        if (livro != null) {
            scanner.nextLine(); // Limpar buffer
...
//parou aqui...
    private void excluirHospedes() {
        ...
        String retorno = hotelController.excluirHospedes(id);
        System.out.println(retorno);
    }
    ...
    private void buscarHospedes() {
        ...
        Hotel livro = hotelController.buscarLivro(id);
        if (livro != null) {
            hotelView.mostrarDetalhesLivro(livro);
        } else {
    ...
    private void emprestarLivro() {
        ...
        Hotel livro = hotelController.buscarLivro(id);
        if (livro != null) {
            Hotel emprestadoCheck = hotelController.buscarLivroEmpr(id);
            if (emprestadoCheck == null) {
                ...
                hotelController.emprestaLivro(livro);
            } else {
    ...
    private void devolverLivro() {
        ...
        Hotel livro = hotelController.buscarLivro(id_livro);
        if (livro == null) {
            System.out.println("Livro não encontrado!");
            return;
        }

        String retorno = hotelController.devolverLivro(id_livro);
        System.out.println(retorno);
    };

    private void listarLivrosEmprestados() {
        System.out.println("=+=+=+= Livros Emprestados =+=+=");
        List<Hotel> livros = hotelController.listarLivrosEmprestados();
        hotelView.mostrarListaLivros(livros);
        System.out.println("=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=");
    }
    ...
    private void buscarEmpre() {
        ...
        int id = scanner.nextInt();
        Hotel livro = hotelController.buscarLivroEmpr(id);
        if (livro != null) {
            hotelView.mostrarDetalhesEmprestimo(livro);
        } else {
            System.out.println("Livro não encontrado!");
        }
    }
